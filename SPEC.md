...
| Loop | Goal |
|---|---|
| Loop 8 | Chapter 2 beats — deeper faction system, Tollmaster consequences |
| Loop 9 | Persistent save via localStorage — resume across sessions |
| Loop 10 | AI-generated character portrait using image API |
| Loop 11 | Faction reputation system — separate tracks for 3+ factions |
| Loop 12 | Multiple endings to Chapter 1 based on accumulated state |
| Loop 13 | Broadsheet interstitials — flavour text between chapters mimicking a newspaper |
